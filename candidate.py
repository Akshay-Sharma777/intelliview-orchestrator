...
class Candidate(Base):
    ...
    needs_review = Column(Boolean, default=False, doc="Flagged if a near-duplicate exists")
    ...
    def is_near_duplicate(session, new_name, new_email, threshold=0.85):
        ...
        for existing in existing_candidates:
            ...
            name_similarity = difflib.SequenceMatcher(None, new_name_lower, existing_name).ratio()
            email_similarity = difflib.SequenceMatcher(None, new_email_lower, existing_email).ratio()
